...
@app.get(
    "/alerts/rsi",
    summary="Get rsi alerts",
    description="Get rsi alert crypto for a symbol and time interval",
)
...
@app.get(
    "/alerts/stochastic-rsi",
    summary="Get stochastic rsi alerts",
    description="Get stochastic rsi alert crypto for a symbol and time interval",
)
...
@app.get(
    "/alerts/macd",
    summary="Get macd alerts",
    description="Get macd alert crypto for a symbol and time interval",
)
...
@app.get(
    "/alerts/bollinger-bands",
    summary="Get bollinger bands alerts",
    description="Get bollinger bands alert crypto for a symbol and time interval",
)
...
@app.get(
    "/alerts/ema-200",
    summary="Get ema-200 alerts",
    description="Get ema-200 alert crypto for a symbol and time interval",
)
...
@app.get(
    "/alerts/moving-averages",
    summary="Get moving averages alerts",
    description="Get moving averages alert crypto for a symbol and time interval",
)
